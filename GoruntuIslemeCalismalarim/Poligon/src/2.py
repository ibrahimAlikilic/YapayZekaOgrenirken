...
# Çember tespiti
circles = cv2.HoughCircles(morph_img, cv2.HOUGH_GRADIENT, 1, img.shape[0]/16, param1=500, param2=30, minRadius=37, maxRadius=300)
# circles = cv2.HoughCircles(morph_img, cv2.HOUGH_GRADIENT, 1, minDist=50, param1=100, param2=30, minRadius=20, maxRadius=100)
