...
##########################################
# Resim
img=cv2.imread("../input/img/11.jpg") # Hatırlatma : Resimleri BGR okur
img_width=640
img_height=427
...
#####################
# Model variable
model=cv2.dnn.readNetFromDarknet("../../../../Masaüstü/YOLOlar/yolov4_coploat_yuklenmeye_hazir/darknet/spot_yolov4.cfg","../../../../Masaüstü/backup-yolov4_spot_robot/backup/spot_yolov4_1000.weights")
